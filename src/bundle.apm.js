/*! @sentry/browser & @sentry/apm 5.11.0 (8870389b) | https://github.com/getsentry/sentry-javascript */
    ...
    ***************************************************************************** */
    ...
    var Span = /** @class */ (function () {
        ...
        Span.prototype.child = function (spanContext) {
            var span = new Span(__assign({}, spanContext, { parentSpanId: this._spanId, sampled: this.sampled, traceId: this._traceId }));
        ...
        Span.fromTraceparent = function (traceparent, spanContext) {
            ...
            if (matches) {
                ...
                return new Span(__assign({}, spanContext, { parentSpanId: matches[2], sampled: sampled, traceId: matches[1] }));
            }
            return undefined;
        };
        /**
        ...
        Span.prototype.setData = function (key, value) {
            var _a;
            this.data = __assign({}, this.data, (_a = {}, _a[key] = value, _a));
            return this;
        };
        /**
         * @inheritDoc
    ...
    var Tracing = /** @class */ (function () {
        ...
        function Tracing(_options) {
            ...
            Tracing.options = this._options = __assign({}, defaults, _options);
        }
        /**
         * @inheritDoc
         */
        Tracing.prototype.setupOnce = function (_, getCurrentHub) {
            ...
            if (global$5.location && global$5.location.href) {
                // `${global.location.href}` will be used a temp transaction name
                Tracing.startIdleTransaction(global$5.location.href, {
                    op: 'pageload',
                    sampled: true,
                });
            }
        ...
        Tracing.startIdleTransaction = function (name, spanContext) {
            ...
            var span = hub.startSpan(__assign({}, spanContext, { transaction: name }), true);
    ...
    function xhrCallback(handlerData) {
        ...
        handlerData.xhr.__sentry_xhr_activity_id__ = Tracing.pushActivity('xhr', {
            data: __assign({}, xhr.data, { type: 'xhr' }),
    ...
    function fetchCallback(handlerData) {
        ...
        if (handlerData.endTimestamp && handlerData.fetchData.__activity) {
            ...
            handlerData.fetchData.__activity = Tracing.pushActivity('fetch', {
                data: __assign({}, handlerData.fetchData, { type: 'fetch' }),
                ...
                if (span) {
                    ...
                    if (options.headers) {
                        if (Array.isArray(options.headers)) {
                            options.headers = __spread(options.headers, [{ 'sentry-trace': span.toTraceparent() }]);
                        }
                        else {
                            options.headers = __assign({}, options.headers, { 'sentry-trace': span.toTraceparent() });
                        }
                    }
                    else {
    ...
    function historyCallback(_) {
        if (Tracing.options.startTransactionOnLocationChange && global$5 && global$5.location) {
            Tracing.startIdleTransaction(global$5.location.href, {
                op: 'navigation',
                sampled: true,
            });
    ...
    // tslint:enable: no-unsafe-any
    var INTEGRATIONS = __assign({}, windowIntegrations, CoreIntegrations, BrowserIntegrations, { Tracing: Tracing });
...
//# sourceMappingURL=bundle.apm.js.map
